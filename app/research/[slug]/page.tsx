...
const components = {
  ...
  th: (props: React.ComponentPropsWithoutRef<"th">) => (
    <th
      className="border-b border-border px-3 py-2 text-left text-xs font-medium text-foreground bg-muted dark:bg-white/5"
      {...props}
    />
  ),
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <Card className="mb-8 bg-panel">
              <CardContent>
                ...
                <h3 className="text-sm font-medium text-foreground mb-1">{project.companyName}</h3>
