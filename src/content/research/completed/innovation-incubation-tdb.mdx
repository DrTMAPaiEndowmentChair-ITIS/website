...
companyLogo: "/companies/tdb-logo.svg"
...
heroImage: "/projects/innovation-incubation-banner.jpg"
status: "completed"
...
|:----------|:------------|
| Incubation Space | Dedicated 5,000 sq. ft. facility with workspaces and labs |
| Prototyping Labs | Specialized equipment for product development |
| Shared Services | Administrative, legal, and accounting support |
| Technology Validation | Testing and certification assistance |
| Market Access Programs | Customer discovery and pilot implementation support |
